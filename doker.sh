...
sudo docker run -d -p 3306:3306 --name CryptoScan -e "MYSQL_ROOT_PASSWORD=aluno" mysql:5.7
...
sleep 15
sudo docker exec -i CryptoScan mysql -u root -paluno < /home/ubuntu/scriptsSh/script.sql
